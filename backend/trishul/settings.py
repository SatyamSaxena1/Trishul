...
INTEGRATION_SECRET_KEY = secret("INTEGRATION_SECRET_KEY")
GIT_CREDENTIAL_PUBLIC_KEY = secret("GIT_CREDENTIAL_PUBLIC_KEY")
GIT_CREDENTIAL_PRIVATE_KEY = secret("GIT_CREDENTIAL_PRIVATE_KEY")
GITHUB_APP_ID = os.getenv("GITHUB_APP_ID", "")
GITHUB_APP_PRIVATE_KEY = secret("GITHUB_APP_PRIVATE_KEY")
GITHUB_API_URL = os.getenv("GITHUB_API_URL", "https://api.github.com")
GITLAB_API_URL = os.getenv("GITLAB_API_URL", "https://gitlab.com/api/v4")
TRISHUL_PUBLIC_URL = os.getenv("TRISHUL_PUBLIC_URL", "")
